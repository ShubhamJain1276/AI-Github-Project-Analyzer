...
import { FolderGit2, Mail, Lock, Eye, EyeOff, ArrowRight, Terminal, Sparkles, Shield, Activity } from 'lucide-react';
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (redirectUrl) navigate('/dashboard', { state: { url: redirectUrl } });
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-md">
          <div className="mb-10">
            ...
            <p className="text-slate-500 text-sm font-medium">Access your analysis history and favorite repositories.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative pt-2">
              ...
              >
                {loading ? (
                  <><div className="w-4 h-4 border-2 border-white/40 border-t-white animate-spin" /> Signing in...</>
                ) : (
            ...
            <div className="text-center mt-8 pt-6 border-t-[2px] border-slate-200">
              <p className="text-sm text-slate-500">
                ...
                <Link to="/register" className="font-black text-black uppercase text-xs tracking-wider border-b-2 border-black hover:opacity-60 transition-opacity">
                  Sign Up
                </Link>
              </p>
            </div>
